...
INSERT INTO `prize` (`prize_id`,`prize_name`,`total_count`,`current_count`,`min_join_count`,`probability`,`active_yn`) VALUES (1,'恭喜你获得竹叶青12月量茶包。',2,2,150000,0.01,'Y');
INSERT INTO `prize` (`prize_id`,`prize_name`,`total_count`,`current_count`,`min_join_count`,`probability`,`active_yn`) VALUES (2,'恭喜你获得车载空气净化器。',10,10,100000,0.05,'Y');
...
INSERT INTO `prize` (`prize_id`,`prize_name`,`total_count`,`current_count`,`min_join_count`,`probability`,`active_yn`) VALUES (4,'恭喜你获得竹叶青品饮小铁盒。',3000,3000,30000,0.2,'Y');
INSERT INTO `prize` (`prize_id`,`prize_name`,`total_count`,`current_count`,`min_join_count`,`probability`,`active_yn`) VALUES (5,'恭喜你获得绿色植物盆栽。',5000,5000,10000,0.3,'Y');
