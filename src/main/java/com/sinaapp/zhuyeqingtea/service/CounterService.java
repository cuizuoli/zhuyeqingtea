...
public class CounterService {
	...
	private String nextWeiboCount() {
		String[] weiboContents = new String[]{
			"#绿茶生活 远离雾霾 拒绝烟花#众人拾柴火焰高，简单的贡献也能汇聚成强大的力量。送成都一个红包，低碳生活，从拒放烟花开始！http://t.cn/8F7uLLS",
			"#绿茶生活 远离雾霾 拒绝烟花#漫天雾霾让人无处可逃，爆表的PM2.5侵害你我的健康，保护环境，从新年拒放烟花开始，赶快来加入我们吧，为成都环保送出一个红包！http://t.cn/8F7uLLS",
			"#绿茶生活 远离雾霾 拒绝烟花#不要让晨练成为历史教材，让防毒面罩变成了户外必须。我们可以不放烟花，但不能不呼吸空气。送成都一个红包，环保从新年做起！http://t.cn/8F7uLLS",
			"#绿茶生活 远离雾霾 拒绝烟花#烟花虽美，却只是昙花一现；红包虽小，代表的是公益之心。送成都一个红包，环保从我做起！http://t.cn/8F7uLLS",
			"#绿茶生活 远离雾霾 拒绝烟花#红包诚可贵，空气价更高，不要爆表的pm2.5，我要蓝天白云！送成都一个红包，过一个低碳环保年！http://t.cn/8F7uLLS"
		};
